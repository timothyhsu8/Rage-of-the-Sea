...
export default class CharacterSelect extends Scene {
    ...
    startScene(){this.addUILayer("characterSelect");
        ...
        /* Back Button */
        const back = <Button>this.add.uiElement(UIElementType.BUTTON, "characterSelect", {position: new Vec2(center.x-650, center.y-375), text: "Home"});
        ...
        if (Input.isJustPressed("escape")){
            ...
            while(this.receiver.hasNextEvent()){
                ...
                if(event.type === "select"){
                    ...
                    let characterState = new CharacterState(100, 0, 0, 75, inventory, "portrait", this.startingLevel);
